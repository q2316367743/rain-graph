<template>
    <a-form :model="style" layout="vertical" class="simple-mind-map-style">
            ...
            <div class="sidebarContent" v-if="activeNodes.length > 0">
                ...
                <div class="row">
                    <div class="rowItem">
                        ...
                        <el-select size="mini" v-model="style.fontFamily" placeholder=""
                            :disabled="checkDisabled('fontFamily')" @change="update('fontFamily')">
                            <el-option v-for="item in fontFamilyList" :key="item.value" :label="item.name"
                                :value="item.value" :style="{ fontFamily: item.value }">
                            </el-option>
                        </el-select>
                    </div>
                </div>
                <div class="row">
                    <div class="rowItem">
                        ...
                        <el-select size="mini" style="width: 80px" v-model="style.fontSize" placeholder=""
                    ...
                    <div class="rowItem">
                        ...
                        <el-select size="mini" style="width: 80px" v-model="style.lineHeight" placeholder=""
                ...
                <div class="row">
                    ...
                    <el-popover ref="popover" placement="bottom" trigger="hover" :disabled="checkDisabled('color')">
                    ...
                    <el-popover ref="popover2" placement="bottom" trigger="hover"
                        ...
                        <el-radio-group size="mini" v-model="style.textDecoration" @change="update('textDecoration')">
                ...
                <div class="row">
                    <div class="rowItem">
                        ...
                        <span class="block" v-popover:popover3
                    ...
                    <div class="rowItem">
                        ...
                        <el-select size="mini" style="width: 80px" v-model="style.borderDasharray" placeholder=""
                            :disabled="checkDisabled('borderDasharray')" @change="update('borderDasharray')">
                            <el-option v-for="item in borderDasharrayList" :key="item.value" :label="item.name"
                                :value="item.value">
                            </el-option>
                        </el-select>
                    </div>
                ...
                <div class="row">
                    <div class="rowItem">
                        ...
                        <el-select size="mini" style="width: 80px" v-model="style.borderWidth" placeholder=""
                    ...
                    <div class="rowItem">
                        ...
                        <el-select size="mini" style="width: 80px" v-model="style.borderRadius" placeholder=""
                ...
                <div class="row">
                    <div class="rowItem">
                        ...
                        <el-select size="mini" style="width: 120px" v-model="style.shape" placeholder=""
                ...
                <div class="row">
                    ...
                    <div class="rowItem">
                        <span class="name">{{ $t('style.style') }}</span>
                        <el-select size="mini" style="width: 80px" v-model="style.lineDasharray" placeholder=""
                ...
                <div class="row">
                    <div class="rowItem">
                        <span class="name">{{ $t('style.width') }}</span>
                        <el-select size="mini" style="width: 80px" v-model="style.lineWidth" placeholder=""
